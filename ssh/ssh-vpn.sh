...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/Newbie2555/perizinan/main/ipvps.txt | grep $MYIP )
if [ $MYIP = $IZIN ]; then
echo -e "${NC}${GREEN}Permission Accepted...${NC}"
else
echo -e "${NC}${RED}Permission Denied!${NC}";
echo -e "${NC}${LIGHT}Please Contact Admin!!"
echo -e "${NC}${LIGHT}Telegram : https://t.me/Waan_ID"
exit 0
fi
# ==================================================
# Link Hosting Kalian
...
colongvpnn="raw.githubusercontent.com/Newbie2555/test-ipv6/main/xray"

# Link Hosting Kalian Untuk Trojan Go
colongvpnnn="raw.githubusercontent.com/Newbie2555/test-ipv6/main/trojango"

# Link Hosting Kalian Untuk Stunnel5
colongvpnnnn="raw.githubusercontent.com/Newbie2555/test-ipv6/main/stunnel5"
